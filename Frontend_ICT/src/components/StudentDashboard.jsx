...
const StudentDashboard = () => {
    ...
    useEffect(()=>{
        axios.get('http://localhost:5000/studentCourse')
        .then((res)=>{
  ...
  return (
    <div>
        <Navbar/>
        <br></br>
        <h2 class="text-primary py-2 text-center"><u>The Student Dashboard</u></h2>
        <div class="row">
            <br/><br/><br/>
            <div class="col-3">
            <br/><br/><br/>
            {/* {studentData.map((item,i)=>( */}
                ...
                <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                        <div class="fw-bold"><u>Name</u> : {studentData.s_name}</div>
                    </div>
                </li>
                <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                        <div class="fw-bold"><u>Course</u> : {studentData.s_course}</div>
                    </div>
                </li>
                <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                        <div class="fw-bold"><u>Mentor</u> : {studentData.s_mentor}</div>
                    </div>
                </li>
                <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                        <div class="fw-bold"><u>Started on</u> : {studentData.s_startdate}</div>
                    </div>
                </li>
                <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                        <div class="fw-bold"><u>Score</u> : {studentData.s_exitscore}</div>
                    </div>
                </li>
                </ol>
                {/* ))} */}
            ...
            <div class="col-9">
                ...
                <div class="col">
                    ...
                    <div class="card h-100">
                        <div class="card-body">
                            <p class="card-text"><i>COURSE : {item.course}</i></p>
